				...
				<div class="container">
					<div class="d-flex align-items-center justify-content-between w-100">
						<div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                            <a class="navbar-brand brand-logo" href=""><img src="{+ siteURL / +}assets/imgs/fmkiddo-logo-landscape-white.png" alt="logo"/></a>
                            <a class="navbar-brand brand-logo-mini" href=""><img src="{+ siteURL +}assets/imgs/fmkiddo-logo-only-square-white.png" alt="logo"/></a>
